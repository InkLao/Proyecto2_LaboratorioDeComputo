...
/**
 * Interfaz para las operaciones CRUD de la entidad Carrera en la capa de persistencia.
 * Define los métodos necesarios para gestionar los datos de las carreras en la base de datos.
 * 
 * @autor Oley
 */
