 ...
 * Proporciona métodos para realizar operaciones CRUD y conversión entre
 * entidades y DTOs.
 *
 * @author Oley
 */
public interface IAlumnoNegocio {
     ...
     *
     * @param alumnoDTO Objeto AlumnoDTO con la información del alumno a
     * guardar.
     ...
     * @return AlumnoDTO con la información del alumno encontrado, o null si no
     * existe.
     */
     ...
     *
     * @return Lista de objetos AlumnoDTO con la información de todos los
     * alumnos.
     */
     ...
     *
     * @param alumnoDTO Objeto AlumnoDTO con la información actualizada del
     * alumno.
     ...
     * @return Lista de objetos AlumnoDTO que coinciden con el nombre
     * especificado.
     */
